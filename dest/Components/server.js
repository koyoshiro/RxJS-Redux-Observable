...
var serverView = function (_React$Component) {
    _inherits(serverView, _React$Component);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "button",
                    {
                        onclick: "(${() => { store.dispatch(requestService(105)); }})();"
                    },
                    "Request 105 Service"
                ),
                _react2.default.createElement(
                    "button",
                    {
                        onclick: "(${() => { store.dispatch(cancelService()); }})();"
                    },
                    "CANCEL Request"
                ),
                _react2.default.createElement(
